...
@Component
@EnableScheduling
public class BybitTickerSpotWebSocket extends WebSocketClient {
    private static final String BASE_API_URL_SOCKET = "wss://stream.bybit.com/v5/public/spot";
    private static final Logger log = LoggerFactory.getLogger(BybitTickerSpotWebSocket.class.getName());
    private Consumer<String> messageHandler;
    private final SymbolsService symbolsService = new SymbolsService(new BybitService());


    public BybitTickerSpotWebSocket() throws URISyntaxException {
